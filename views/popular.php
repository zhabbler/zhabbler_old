...
<div id="SysContentPage">
            <div id="tabs">
                <a id="tab" href="/dashboard">
                    Подписки
                </a>
                <a id="tab" class="tab_active" href="/popular">
                    Популярное
                </a>
            ...
            <div id="posts_lent">
            <?php Zhabs::getAllZhabsPopular(0) ?>
            </div>
            <script>
                ...
                function infScroll(){
                    $(document).scroll(function(e){
                        ...
                        if($(window).scrollTop() == $(document).height() - $(window).height()){
                            ...
                            $.post("/API/zhabs/totalCount", function (data) {
                                if($("#post").length < Number(data)) {
                                    $(window).off("scroll");
                                    $.post("/API/zhabs/getAllZhabsPopular", {lastid:Number($("#posts_lent .RealZhab").last().attr("realid"))}, function(data){
