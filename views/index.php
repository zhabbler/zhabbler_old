...
<body id="application" class="systemUnlogedAccount">
    ...
    <div class="systemUnlogedAccountForm">
        <div>
            ...
            <div id="SR2Bc">
                <div class="systemRegister2buttons">
                    <div class="systemRegister2buttonsContainer">
                        <button class="button" onclick="registerForm();" type="button">Создать аккаунт</button>
                        <button class="button button_gray" onclick="loginForm();" type="button">Войти</button>
                    </div>
                </div>
                <form method="POST" style="display:none;margin-left:270px;" id="JS__Register" action="/API/account/register">
                    <div id="JS__Step1" class="systemSteps">
                        ...
                        <div>
                            <input type="nickname" class="systemInput" placeholder="Никнейм" name="nickname">
                        </div>
                        <div>
                            <button class="button" type="button" onclick="registerFirstStep();">Далее</button>
                        </div>
                    </div>
                    <div id="JS__Step2" style="display:none;" class="systemSteps">
                        <div>
                            <input type="text" class="systemInput" placeholder="Имя" name="name">
                        </div>
                        <div id="LYZeI84lhn">
                            <input type="checkbox" onchange="checkboxSC();" name="agree" value="1">
                            <label>Я прочитал <a href="/help/tos">Условия использования</a> и полностью согласен с ними</label>
                        </div>
                        <div>
                            <button class="button BTNreg" disabled type="submit">Готово!</button>
                            <button class="button button_gray" onclick="backToFirst();" type="button">Назад</button>
                        </div>
                    </div>
                </form>
                <form method="POST" style="display:none;margin-left:270px;" id="JS__Login" action="/API/account/login">
                    <div id="JS__Step1" class="systemSteps">
                        <div>
                            <input type="email" class="systemInput" placeholder="Электронный адрес" name="email">
                        </div>
