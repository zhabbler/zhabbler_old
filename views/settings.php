...
if($user->activated != 1){
    Alert::PushMessage("Вы не можете зайти на данную страницу из-за ограничений.");
    User::redirect("/");
}
?>
...
<?=(isset($_COOKIE['authCode']) ? ($user->activated != 1 ? '<div class="alertSticky">
    ...
    <div id="container">
        <nav id="sidebar">
            ...
            <a href="/settings" class="sidebarElementClicked" id="sidebarElement">
                <div id="sidebarElementIcon">
...
<div id="SysContentPage">
            <div class="ui__U5ZaRx__6FTCsc">
                <div>
                    <div class="ui__a5apHh__kiPO6I">
                        <div class="ui__NUOT9m__Nx9Ojq" onclick="location.href = '/profile/<?=$user->nickname?>';"><?=$user->nickname?><span class="ui__S1uFdE__10XPnf"></span></div>
                        <div class="flex ml-a">
                        <button class="button button_white settingsChngPrms">Изменить</button>
                        </div>
                    </div>
                    <div class="profileInformationCover" style="<?php if(!empty($user->profileCover)){?> background: url('<?=$user->profileCover?>') center/cover; <?php } ?>">
                    <label class="settingsButtonIcon">
                            <input type="file" name="image_COVER" id="imageACCovhid" onchange="return submitChngCover();" hidden="" accept="image/*">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8.707 19.707 18 10.414 13.586 6l-9.293 9.293a1.003 1.003 0 0 0-.263.464L3 21l5.242-1.03c.176-.044.337-.135.465-.263zM21 7.414a2 2 0 0 0 0-2.828L19.414 3a2 2 0 0 0-2.828 0L15 4.586 19.414 9 21 7.414z"></path></svg>
                        </label></div>
                    <div class="profileInformationProfilePicture" id="system__settings__pfp">
                        <label class="settingsButtonIcon" style="margin-top: -30px;">
                            <input type="file" name="image_avatar" id="imageACChid" onchange="return submitChngPfp();" hidden="" accept="image/*">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M8.707 19.707 18 10.414 13.586 6l-9.293 9.293a1.003 1.003 0 0 0-.263.464L3 21l5.242-1.03c.176-.044.337-.135.465-.263zM21 7.414a2 2 0 0 0 0-2.828L19.414 3a2 2 0 0 0-2.828 0L15 4.586 19.414 9 21 7.414z"></path></svg>
                        </label>
                ...
                <div class="ui__BvWmUQ__IpAxKw" id="pre_pre_color_input_inputs">
                    <div class="ui__9YWdMP__5m113d">
                        <span>
                            Цветовая палитра
                        </span>
                    </div>
                    <div>
                        <div>
                            <div class="input__color">
                                <div class="input__color__itself" style="background:<?=(!empty($user->colorPallete) ? $user->colorPallete : "#13b552")?>;"></div>
                            </div>
                            <div class="input__colors" style="display:none">
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#13b552;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#1362b5;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#940fd7;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#f200ff;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#d5d218;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#ef6900;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#ff1515;"></div>
                                </div>
                                <div class="input__color input__color__val">
                                    <div class="input__color__itself" style="background:#909090;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="ui__BvWmUQ__IpAxKw">
                    <div class="ui__9YWdMP__5m113d">
                        <span>
                            Темы
                        </span>
                    </div>
                    <div class="ui__LLZhTv__fDdPEd">
                        <a href="#" id="settings__changeTheme">В<?=(isset($_COOKIE['theme']) ? "ы" : '')?>ключить тёмную тему</a>
                    </div>
                </div>
                <div class="ui__BvWmUQ__IpAxKw">
                    <div class="ui__9YWdMP__5m113d">
                    ...
                    <div class="ui__LLZhTv__fDdPEd">
                        <span>
                            <?php
                                list($first, $last) = explode('@', $user->email);
                                ...
                                echo $hideEmailAddress;
                            ?>
                        </span>
                        <div class="ui__3nBVzS__nsTc1V" onclick="InformationAboutChangingEmail()">
                ...
                <div class="ui__BvWmUQ__IpAxKw">
                    ...
                    <div class="ui__LLZhTv__fDdPEd">
                        ...
                        <div class="ui__3nBVzS__nsTc1V" onclick="ChangePassword()">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                              <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" />
                              <path d="M5.25 5.25a3 3 0 00-3 3v10.5a3 3 0 003 3h10.5a3 3 0 003-3V13.5a.75.75 0 00-1.5 0v5.25a1.5 1.5 0 01-1.5 1.5H5.25a1.5 1.5 0 01-1.5-1.5V8.25a1.5 1.5 0 011.5-1.5h5.25a.75.75 0 000-1.5H5.25z" />
                            </svg>
                ...
                <div class="ui__BvWmUQ__IpAxKw">
                    ...
                    <div class="ui__LLZhTv__fDdPEd">
                        <div class="ui__0SWCHY__k98vZ1">
                            <span class='loading'><span id='ldF'></span><span id='ldS'></span><span id='ldT'></span></span>
                        </div>
                        <div class="form_content ui__25frhH__OGJDcH" id="GenderSettings">
                            <label for="gender" class="formLabel formLabelFocused">пол</label>
                            <select onchange="changeGender()" name="gender" class="input" id="gender">
                                <option value="1" <?=($user->gender == 1 ? 'selected' : '')?>>Женский</option>
                                <option value="2" <?=($user->gender == 2 ? 'selected' : '')?>>Мужской</option>
                                <option value="3" <?=($user->gender == 3 ? 'selected' : '')?>>Скрыт</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="ui__BvWmUQ__IpAxKw">
                    ...
                    <div class="ui__LLZhTv__fDdPEd">
                        <div class="ui__lrXT8p__DGoy8a">
                            <span class='loading'><span id='ldF'></span><span id='ldS'></span><span id='ldT'></span></span>
                        </div>
                        <div class="ui__k8xdRJ__PNCLuN">
                            <div>
                                <span>
                                    <?=date_parse($user->birth)['day']." ".Date::month(date_parse($user->birth)['month'])." ".date_parse($user->birth)['year']?>
                                </span>
                            </div>
                            <div>
                                <small class="ui__nxcdWN__HqOmDY">
                                    Смена дня рождения на данный момент запрещена.
                                </small>
                            </div>
                            <form method="post" action="/API/account/showBirth" class="flex ai-c">
                                <div>
                                    <input type="checkbox" name="ShowBirthDate" onchange="this.form.submit()" <?=($user->showBirth == 1 ? 'checked' : '')?>>
                                </div>
                                <div>
                                    <span>
                ...
                <div class="ui__95CBnJ__c8MtHF ui__aRTC4j__4VMwYy">
                    Конфиденциальность
                </div>
                <div class="ui__BvWmUQ__IpAxKw">
                    <div class="ui__9YWdMP__5m113d">
                    ...
                    <div class="ui__LLZhTv__fDdPEd ui__uTGUio__tCC988">
                        <div class="form_content ui__25frhH__OGJDcH">
                            <label for="gender" class="formLabel formLabelFocused">выберите</label>
                            <select onchange="confidentSettings('msgs')" name="msgs" class="input" id="cfmsgs">
                                <option value="0" <?=($user->cf_messages == 0 ? 'selected' : '')?>>Все</option>
                                <option value="1" <?=($user->cf_messages == 1 ? 'selected' : '')?>>Только те пользователи, на которых я подписан</option>
                                <option value="2" <?=($user->cf_messages == 2 ? 'selected' : '')?>>Только те пользователи, которые на меня подписаны</option>
                                <option value="3" <?=($user->cf_messages == 3 ? 'selected' : '')?>>Только те пользователи, с которыми я дружу</option>
                                <option value="4" <?=($user->cf_messages == 4 ? 'selected' : '')?>>Никто</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="ui__BvWmUQ__IpAxKw">
                    <div class="ui__9YWdMP__5m113d">
                        <span>
                            Как показывать дату рождения?
                        </span>
                    </div>
                    <div class="ui__LLZhTv__fDdPEd ui__uTGUio__tCC988">
                        <div class="form_content ui__25frhH__OGJDcH">
                            <label for="gender" class="formLabel formLabelFocused">выберите</label>
                            <select onchange="confidentSettings('birth')" name="birth" class="input" id="cfbirth">
                                <option value="0" <?=($user->cf_birth == 0 ? 'selected' : '')?>>День Месяц Год</option>
                                <option value="1" <?=($user->cf_birth == 1 ? 'selected' : '')?>>День Месяц</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="ui__BvWmUQ__IpAxKw">
                    ...
                    <div class="ui__LLZhTv__fDdPEd">
                        <div>
                            <span>
                                Всего сеансов: <?=DB::RowCount("SELECT * FROM auths WHERE authToken = :token", [":token" => $user->token])?>
                            </span>
                        </div>
                        <div class="ui__htt8GS__AZiWP6">
                            <button class="button button_gray" onclick="logoutFromAllSessions()">
