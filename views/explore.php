...
<div id="SysContentPage">
            <div id="tabs">
                ...
                <a id="tab" class="tab_active" href="/explore">
                    Обзор
                </a>
            </div>
            <?php
                        ...
                        if($(window).scrollTop() == $(document).height() - $(window).height()){
                            ...
                            $.post("/API/zhabs/totalCount", function (data) {
                                if($("#post").length < Number(data)) {
                                    $(window).off("scroll");
                                    $.post("/API/zhabs/getAllZhabs", {lastid:Number($("#posts_lent .RealZhab").last().attr("realid"))}, function(data){
