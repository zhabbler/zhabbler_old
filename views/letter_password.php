...
<body id="application" style="height:100vh;" class="SystemRegister">
    ...
    <form class="SystemRegisterForm" action="/API/letters/password" method="post">
        ...
        <div>
            <span class="LandingStr">
                Введите необходимые поля для ввода
            </span>
        </div>
        <br>
        <div>
            ...
            <div class="form_content">
                <label for="pwdPassword" class="formLabel">новый пароль</label>
                <input type="password" name="password" id="pwdPassword" autocomplete="off" class="input">
            </div>
