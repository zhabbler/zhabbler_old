...
<div id="SysContentPage">
            <div id="tabs">
                <a id="tab" href="/profile/<?=$nickname?>/followers">
                ...
                <a id="tab" class="tab_active" href="/profile/<?=$nickname?>/following">
            ...
            <?php
            foreach(DB::Query("SELECT * FROM follows LEFT JOIN users ON userID = followTo WHERE followBy = :to AND reason = '' ORDER BY followID DESC", true, true, [":to" => $profile->userID]) as $followed){
