...
<div id="SysContentPage">
            <h1 style="margin:20px;">
                Сообщения
                <small id="smZal02">(beta)</small>
            </h1>
            <div id="messagesConvs">
                <span class='loading'><span id='ldF'></span><span id='ldS'></span><span id='ldT'></span></span>
            </div>
            <script>
                $(document).ready(function(){
                    setInterval(() => {
                        $.get("/API/messages/showConversations", function(data){
                            if(data != $("#mainContent #messagesConvs").html()){
                                $("#mainContent #messagesConvs").html(data);
                            }
                        });
                    }, 250);
                });
