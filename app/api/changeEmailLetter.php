...
DB::Query("INSERT INTO emailChanger(emailChangerTo, emailChangerGetID) VALUES(:to, :getID)", false, false, [":to" => $user->userID, ":getID" => $URLCode]);
try {
    $mail->isSMTP();
    ...
    $mail->CharSet = "UTF-8";
    $mail->isHTML(true);
    $mail->Subject = 'Изменение почты в Жабблере';
                    ...
                    <table style="width:600px;background-color:#003510;">
                        <tr>
                            <td>
                                <center>
                                    <span>
                                        Нажмите на кнопку ниже чтобы изменить вашу почту.
                                    </span>
                                </center>
                            </td>
                        </tr>
                    ...
                    <table style="width:600px;background-color:#003510;">
                        <tr>
                            <td>
                                <center>
                                    <br><br>
                                    <a href="https://zhabbler.ru/letters/email/'.$URLCode.'" style="text-decoration:none;background-color: #13b552;color: #fff;border: 0;cursor: pointer;padding: 10px;font-size: 16px;font-weight: 600;border-radius: 3px;">
                                        Изменить почту
                                    </a>
                                    <br><br><br>
                                </center>
